...
<div class="email_body" style="-webkit-border-radius: 10px;-moz-border-radius: 10px;border-radius: 10px;border: 2px solid #9f9999;text-align: center;background-color: #f2f2f5;">
                        ...
                        <tr>
                          <td class="column_cell font_default" align="center" valign="top" style="padding: 16px;font-family: Helvetica, Arial, sans-serif;font-size: 15px;text-align: center;vertical-align: top;color: #888888;">
                           <table class="icon_holder icon_primary" width="80" border="0" align="center" cellpadding="0" cellspacing="0" style="border-spacing: 0;mso-table-lspace: 0pt;mso-table-rspace: 0pt;width: 48px;margin-left: auto;margin-right: auto;clear: both;">
                            ...
                            <h3 style="font-family: Helvetica, Arial, sans-serif;margin-left: 0;margin-right: 0;margin-top: 16px;margin-bottom: 8px;padding: 0;font-size: 22px;line-height: 3px;font-weight: bold;color: #2f68b4;">Authentication OTP Code</h3>
                          </td><!-- /.column_cell -->
                        </tr>
                      </tbody>
                    </table><!-- /.column -->
        ...
        <tbody>
          <tr>
            <td class="content_cell" align="center" valign="top" style="padding: 0;text-align: center;background-color: #ffffff;font-size: 0 !important;">
				...
				<b>Seseorang telah melakukan permintaan untuk menutup akun Anda.</b></p>
				<p>Jika Anda tidak melakukannya, mohon abaikan email ini.</p>

				<p>Silahkan mengisi kode konfirmasi untuk melakukan verifikasi identitas Anda. Hal ini dilakukan untuk menjaga keamanan akun Anda.</p>

				<p>Kode OTP Anda: {!! $otp_code !!}</p>

				<p>Butuh bantuan? Silahkan kunjungi website support kami (<a href="http://support.scoido.com">http://support.scoido.com</a>)</p>
  ...
  <!-- <div>
    <h1>Hai {!! $first_name !!}</h1>
    <h3>Someone has request for Close Account, if don't disobey this email.</h3>
    <p>To close your account please fill this code on OTP code form : {!! $otp_code !!}</p>
  </div> -->