...
@section('title', 'Report Member Statistic')

@section('page-header', 'Report Member Statistic')
...
@section('breadcrumb')
	<ol class="breadcrumbs">
	  ...
	  <li><span>Report Member Statistic</span></li>
	</ol>
@endsection
...
@section('content')
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-2">
                        <select data-plugin-selectTwo class="form-control" onchange="location = this.value;">                                               
                                <option value="{{ route('admin-hq-member-statistic', ['filter' => "year"]) }}" @if($filter == "year") selected @endif>Year</option>
                                <option value="{{ route('admin-hq-member-statistic', ['filter' => "month"]) }}" @if($filter == "month") selected @endif>Month</option>
                                <option value="{{ route('admin-hq-member-statistic', ['filter' => "day"]) }}" @if($filter == "day") selected @endif>Day</option>                                                    
                        </select>
                    </div>
                </div>
            </form>
	...
	<div class="panel panel-default">
        ...
        <div class="panel panel-primary">
            ...
            <div class="panel-body">
                <table id="list-member-table" class="table table-hover table-bordered table-condensed table-responsive dt-responsiv" data-tables="true">
                    <thead>
                        <tr>
...
$('html').addClass(' sidebar-left-collapsed');
       ...
       var list_member_table = $('#list-member-table').DataTable({
            ...
            serverSide: true,
            ajax: {
                url : "{!! route('admin-datatables-member-statistic') !!}",
                data: function(d){
