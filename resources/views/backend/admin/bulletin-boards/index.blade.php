    ...
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        <div class="modal-header bg-primary">
          <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
          <h4 class="modal-title FormBulletinBoard-title" id="myModalLabel">Add</h4>
        </div>
        <div class="modal-body">
        {!! Form::open(['route'=>'admin-post-bulletin-board', 'files'=>true, 'class' => 'form-horizontal jquery-form-bulletin-board']) !!}
                ...
                <div class="form-group area-insert-update">
                    {!! Form::label('plan_id', 'Plan', array('class' => 'col-lg-3 control-label')) !!}
                    <div class="col-lg-9">
                        ...
                        <p class="has-error text-danger error-plan_id"></p>
                    </div>
                    <div class="clear"></div>
                </div>
                <div class="form-group area-insert-update">
...
@section('scripts')
    ...
    <script>
        ...
        function show_form_add(){           
            $('.FormBulletinBoard-title').html('Add Bulletin Board');
            $("[name='method']").val('add');
            $("[name='title']").val('');
            $("[name='content']").val('');
        ...
        function show_form_edit(id){          
            $.ajax({
                ...
                success: function(response)
                {
                    ...
                    $("input[name=plan_id][value=" + response.plan_id + "]").prop('checked', true);
            ...
            $('.area-publish').hide();
            $('.area-unpublish').hide();
            $('.FormBulletinBoard-title').html('Edit Bulletin Board');
