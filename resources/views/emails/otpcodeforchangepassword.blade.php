...
<div class="email_body" style="-webkit-border-radius: 10px;-moz-border-radius: 10px;border-radius: 10px;border: 2px solid #9f9999;text-align: center;background-color: #f2f2f5;">
        ...
        <tbody>
          <tr>
            <td class="content_cell" align="center" valign="top" style="padding: 0;text-align: center;background-color: #ffffff;font-size: 0 !important;">
				...
				<b>Seseorang telah melakukan permintaan untuk merubah password pada akun Anda.</b></p>
				<p>Jika Anda tidak melakukannya, mohon abaikan email ini.</p>

				<p>Silahkan mengisi kode konfirmasi untuk melakukan verifikasi. Hal ini dilakukan untuk menjaga keamanan akun Anda.</p>
  ...
  <!-- <div>
    ...
    <h3>Someone has request for Change password, if don't disobey this email.</h3>

    <p>

    To change your password please fill this code on OTP code form : {!! $otp_code !!}
