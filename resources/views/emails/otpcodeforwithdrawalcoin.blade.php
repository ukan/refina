        ...
        <tbody>
          <tr>
            <td class="content_cell" align="center" valign="top" style="padding: 0;text-align: center;background-color: #ffffff;font-size: 0 !important;">
				...
				<b>Someone has request to Withdrawal Coin.</b></p>
				<p>If it’s not you, disobey this email.</p>
				<p>Please fill the confirmation code so we can verify your identity. This helps keep your account safe.</p>
				<p>Your OTP code: {!! $otp_code !!}</p>
				<p>Have a question or need help? Visit our Support Site (<a href="http://scoido.com/support">http://scoido.com/support</a>)</p>
...
<!-- <div style="background-color:#fff;text-align:left;">
	...
	<hr>
	<p>Someone has request to Withdrawal Coin.</p>
	<p>If it’s not you, disobey this email.</p>
	<p>Please fill the confirmation code so we can verify your identity. This helps keep your account safe.</p>
	<p>Your OTP code:</p>
	<p>Have a question or need help? Visit our Support Site (<a href="http://scoido.com/support">http://scoido.com/support</a>)</p>
	<p>You are receiving this email because have registered on Scoido | <a href="http://scoido.com/unsubscribe">Unsubscribe</a></p>
</div> -->
