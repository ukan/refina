                    ...
                    <table class="column" width="100%" border="0" cellspacing="0" cellpadding="0" style="border-spacing: 0;mso-table-lspace: 0pt;mso-table-rspace: 0pt;width: 100%;vertical-align: top;">
                      <tbody>
                        <tr>
                          ...
                          {!! $instruction !!}
                          <strong>Jika Anda melakukan pembayaran, klik link di bawah ini untuk memverifikasi pembayaran :</strong> <br>
                          <a href="{{ route('payment-confirmation-form',[base64_encode('coin-order'),base64_encode($order_id)]) }}">{{ route('payment-confirmation-form',[base64_encode('coin-order'),base64_encode($order_id)]) }}</a>
                          </td><!-- /.column_cell -->
                        </tr>
                      </tbody>
                    </table><!-- /.column -->
