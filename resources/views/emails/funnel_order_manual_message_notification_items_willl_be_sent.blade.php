                        ...
                        <tr>
                          <td class="column_cell font_default" align="center" valign="top" style="padding: 16px;font-family: Helvetica, Arial, sans-serif;font-size: 15px;text-align: center;vertical-align: top;color: #888888;">
                           <p style="font-family: Helvetica, Arial, sans-serif;font-size: 15px;line-height: 23px;margin-top: 16px;margin-bottom: 24px;">Hello {{ $billing_address_first_name }},<br>
                            Here is a Notification of your recent order made on <strong>{{ $created_date }}</strong>.<!--  You can also view your order in the <a href="#" style="display: inline-block;text-decoration: none;font-family: Helvetica, Arial, sans-serif;color: #2f68b4;"><strong>Purchased</strong></a> section of your account. --></p>
                            <p><b>Thank You, For Your Payment. Items Will Be Sent</b></p>
